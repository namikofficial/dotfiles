...
var profiles = {
    // ── current default: dark, saturated, high contrast ──
    "material-expressive": {
        tonals: {
            background:               "#090B10",
            primary:                  "#8FA8FF",
            onPrimary:                "#101A3A",
            primaryContainer:         "#293A75",
            onPrimaryContainer:       "#DCE3FF",
            secondary:                "#7CE0D3",
            onSecondary:              "#08201D",
            secondaryContainer:       "#20504A",
            onSecondaryContainer:     "#B8F3EA",
            tertiary:                 "#D4B6F2",
            onTertiary:               "#261334",
            tertiaryContainer:        "#503A68",
            onTertiaryContainer:      "#EFDFFF",
        },
        surfaces: {
            surface:                  "#11141C",
            surfaceContainerLow:      "#0E1117",
            surfaceContainer:         "#181C27",
            surfaceContainerHigh:     "#222838",
            surfaceContainerHighest:  "#2C3344",
            surfaceVariant:           "#303749",
            inverseSurface:           "#E1E5EF",
            inverseOnSurface:         "#282B33",
        },
        text: {
            primary:                  "#F2F5FA",
            secondary:                "#D7DEEA",
