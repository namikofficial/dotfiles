...
PanelWindow {
    ...
    property string islandState: "idle"; property bool rendered: false; property bool expanded: false
    ...
    // Window: right below bar, full width, centered internal pill/card
    screen: root.screen; color: "transparent"; visible: rendered
    anchors.top: true; anchors.left: true; anchors.right: true
    margins.top: Theme.Tokens.scaled(Theme.Tokens.heightToolbar + Theme.Tokens.spacingXs)
    exclusiveZone: 0; aboveWindows: true; focusable: false
    implicitHeight: expanded ? Theme.Tokens.scaled(76) : Theme.Tokens.scaled(36)

    readonly property real pillW: Theme.Tokens.scaled(220)
    ...
    Rectangle {
        ...
        width: root.expanded ? root.expandW : root.pillW; height: parent.height
        radius: root.expanded ? Theme.Tokens.radiusXl : Theme.Tokens.radiusPill
        ...
        RowLayout { anchors.fill: parent; anchors.margins: root.expanded ? Theme.Tokens.spacingLg : Theme.Tokens.spacingSm; spacing: root.expanded ? Theme.Tokens.spacingMd : Theme.Tokens.spacingSm
            Text { text: root.activityIcon; color: Theme.Tokens.tonalPrimary; font.family: "Symbols Nerd Font Mono"; font.pixelSize: root.expanded ? Theme.Tokens.iconLg : Theme.Tokens.iconSm; Layout.alignment: Qt.AlignVCenter }
            ColumnLayout { Layout.fillWidth: true; spacing: root.expanded ? Theme.Tokens.scaled(Theme.Tokens.spacingXs) : 0
                Text { text: root.activityLabel; color: Theme.Tokens.textPrimary; font.family: Theme.Tokens.typographyFontFamily; font.pixelSize: root.expanded ? Theme.Tokens.typographyLabelLarge : Theme.Tokens.typographyBodySmall; font.bold: root.expanded; elide: Text.ElideRight; Layout.fillWidth: true }
                Rectangle { Layout.fillWidth: true; height: root.expanded ? 5 : 3; radius: 2; color: Theme.Tokens.outlineSubtle; visible: root.activityMaximum > 1 && root.activityValue >= 0
            ...
            Text { visible: !root.expanded && root.activityMaximum > 1; text: root.displayPercent + "%"; color: Theme.Tokens.textSecondary; font.family: Theme.Tokens.typographyFontFamily; font.pixelSize: Theme.Tokens.typographyLabelSmall; Layout.alignment: Qt.AlignVCenter }
        }
    }
