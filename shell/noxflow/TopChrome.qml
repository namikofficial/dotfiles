...
PanelWindow {
    ...
    color: "transparent"
    aboveWindows: true
    // Keep transparent pixels click-through. The bar remains interactive
    // across its reserved strip; below it, only the visible island card owns
    // input as it morphs between compact, dashboard, calendar, and launcher.
    mask: Region {
        Region { item: bar }
