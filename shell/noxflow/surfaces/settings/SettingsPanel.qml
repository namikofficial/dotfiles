                ...
                ColumnLayout {
                        ...
                        delegate: Rectangle {
                            ...
                            RowLayout {
                                ...
                                Text {
                                    ...
                                    font.bold: true; visible: isActive
                                }
                            }
                    ...
                    Flow {
                        ...
                        Components.TextButton {
                            text: "Reload Shell"
                            onClicked: {
                                Quickshell.exec("systemctl --user reload noxflow-shell")
                        ...
                        Components.TextButton {
                            text: "Restart Daemon"
                            onClicked: {
                                Quickshell.exec("systemctl --user restart noxd")
                        ...
                        Components.TextButton {
                            text: "Gallery"
                            onClicked: {
                                Quickshell.exec("systemctl --user start noxflow-gallery")
                                lifecycle.requestClose("gallery")
                            }
                        }
                    }
                }
