...
hl.animation({ leaf = "windows", enabled = true, speed = 6, spring = "windowIn", style = "popin 86%" })
hl.animation({ leaf = "windowsIn", enabled = true, speed = 6, spring = "windowIn", style = "popin 82%" })
...
hl.animation({ leaf = "workspaces", enabled = true, speed = 7, spring = "workspaceFlow", style = "slidefade 28%" })
hl.animation({ leaf = "workspacesIn", enabled = true, speed = 7, spring = "workspaceFlow", style = "slidefade 28%" })
hl.animation({ leaf = "workspacesOut", enabled = true, speed = 5, bezier = "workspaceExit", style = "slidefade 28%" })
hl.animation({ leaf = "specialWorkspace", enabled = true, speed = 8, spring = "windowIn", style = "slidefadevert 28%" })
hl.animation({ leaf = "specialWorkspaceIn", enabled = true, speed = 8, spring = "windowIn", style = "slidefadevert 34%" })
