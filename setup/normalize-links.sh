...
force_link "$HOME/.cache/hypr/theme-colors-waybar.css" "$HOME/.config/waybar/theme-colors-waybar.css"
force_link "$HOME/.cache/hypr/theme-colors-rofi.rasi" "$HOME/.config/rofi/theme-colors-rofi.rasi"
force_link "$HOME/.cache/hypr/theme-colors-swaync.css" "$HOME/.config/swaync/theme-colors-swaync.css"
force_link "$HOME/.cache/hypr/theme-colors-eww.scss" "$HOME/.config/eww/theme-colors-eww.scss"
