...
- `Super + S`: scratchpad dashboard for launching one pad or the full scene; press again to close
- `Super + Ctrl + S`: toggle context-aware project logs
- `Super + Alt + S`: toggle the local AI scratchpad
